...
def create_vm_manager_and_provider(provider_name: str, region: str, use_proxy: bool = False):
    ...
    elif provider_name == "docker_server":
        print("Using docker_server provider")
        from desktop_env.providers.docker_server.manager import DockerVMManager
        from desktop_env.providers.docker_server.provider import RemoteDockerProvider
        return DockerVMManager(), RemoteDockerProvider(region)
